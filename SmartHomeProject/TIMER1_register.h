...
#ifndef  TIMER_1_REGISTER_H_
#define  TIMER_1_REGISTER_H_
...
#define TCCR1B_ICES1	6		// Ip Capture Edge Select	// 1-> Rising ,, 0->Falling
#define TCCR1B_ICNC1	7		// Ip Capture Noise Canceler
...
#define TIMER1_TCNT1H		*((volatile u8*)0x4D)	//Timer Counter value
